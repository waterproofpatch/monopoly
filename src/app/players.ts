...
export const PLAYERS: Player[] = [
  ...
  { img: 'cat', name: 'Cat', money: STARTING_MONEY, human: true },
  { img: 'duck', name: 'Duck', money: STARTING_MONEY, human: true },
  { img: 'penguin', name: 'Penguin', money: STARTING_MONEY, human: true },
